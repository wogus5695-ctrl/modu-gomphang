  ...
  const configs: Record<string, any> = {
    ...
    '방수': {
      ...
      faqs: [
        ...
        { question: "공사 시 이웃 세대나 주변에 피해가 가지는 않나요?", answer: "외벽 방수 및 도색 시에는 방수재나 페인트가 비산되지 않도록 보양 작업을 철저히 하고 고소 로프 작업을 진행하므로 이웃집이나 주차된 차량에 피해가 가지 않도록 철저히 관리합니다." },
        { question: "건물 외벽 방수 공사는 며칠 정도 소요되나요?", answer: "건물의 크기와 균열 상태에 따라 다르지만 보통 빌라나 상가 기준 2~4일 정도 소요됩니다. 첫날 균열 컷팅 및 하도 처리 후 충분한 건조 시간을 거쳐 방수제와 코팅을 도포합니다." },
        { question: "견적 문의 시 준비해야 하거나 미리 확인해야 할 사항이 있나요?", answer: "건물의 전체적인 전경 사진과 누수가 발생하는 실내 벽면 사진을 촬영하여 문자로 보내주시면 가장 빠르고 정확한 1차 견적을 안내받으실 수 있습니다." }
      ]
    }
  };
