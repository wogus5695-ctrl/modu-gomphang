...
export const services: Service[] = [
  {
    ...
    description: "RainGuard의 곰팡이 제거는 창틀누수 보수와 함께 진행되는 핵심 정밀 서비스입니다. 결로 현상 분석부터 포자균 박멸까지 체계적인 프로세스로 쾌적한 환경을 약속합니다.",
    ...
    content: `
      ...
      RainGuard는 보이지 않는 곳의 포자균까지 찾아내어 완벽하게 박멸하는 것을 원칙으로 합니다.
    `
  },
  {
    id: "window-caulking",
    ...
    description: "빗물 누수와 외풍의 주범인 갈라진 창틀 실리콘! RainGuard의 정밀 코킹 시공으로 누수 차단은 물론 에너지 효율까지 높여드립니다.",
    ...
    content: `
      ...
      RainGuard는 단순히 겉면만 덮는 방식이 아닌, 노후 실리콘의 완전한 제거와 
