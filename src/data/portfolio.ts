...
export const portfolioCases: PortfolioCase[] = [
  ...
  },
  {
    ...
    service: "아파트 창틀코킹 및 빗물누수 보수",
    siteType: "아파트",
    title: "서초구 방배동 아파트 작업현장",
    summary: "비바람이 불 때마다 베란다로 물기가 유입되던 현장입니다.\n빗물누수로 높아진 습기 때문에 곰팡이도 계속 발생했지만,\n원인이 된 창틀 코킹을 재시공하여\n누수 문제를 해결한 사례입니다.",
    problem: "베란다 창틀 주변의 실리콘 노후화로 인해 우천 시 물기가 실내로 유입되고 있었으며, 이로 인해 벽면 곰팡이와 습기 문제가 심각한 상태였습니다.",
    workDetails: [
    ...
    resultSummary: "창틀 코킹 재시공을 통해 빗물 유입을 완벽히 차단하였으며, 누수 해결과 함께 실내 습기 조절 및 곰팡이 원인을 근본적으로 해결했습니다.",
    relatedServiceSlug: "window-caulking",
