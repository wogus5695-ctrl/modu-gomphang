...
export const portfolioCases: PortfolioCase[] = [
  {
    ...
    siteType: "대단지 아파트",
    title: "부천시 상동 아파트 노후 창틀 실리콘 교체 및 누수 차단",
    summary: "장마철 창틀 사이로 스며드는 빗물 누수 문제를 해결하기 위해 노후된 실리콘을 전면 제거하고 창틀 전용 실런트로 재시공했습니다.",
    ...
    beforeImg: "https://images.unsplash.com/photo-1513694203232-719a280e022f?q=80&w=2069&auto=format&fit=crop",
    afterImg: "https://images.unsplash.com/photo-1600585152220-90363fe7e115?q=80&w=2070&auto=format&fit=crop",
    date: "2024-03-25",
  },
  {
    id: "incheon-guwol-villa",
    region: "인천시 남동구 구월동",
    location: "인천",
    category: "wall",
    service: "빌라 외벽 창틀 누수 및 실리콘 보수",
    siteType: "다세대 빌라",
    title: "인천 구월동 빌라 창틀실리콘 노후로 인한 벽지 젖음 해결",
    summary: "안방 창문 주변의 벽지가 빗물에 젖는 문제를 해결하기 위해 샷시코킹 보수 작업을 진행했습니다.",
    problem: "안방 창틀 주변 외벽 실리콘이 삭아서 가루가 날리는 상태였으며, 비가 오면 벽지가 축축하게 젖어 곰팡이가 발생하기 직전의 위험한 상황이었습니다.",
    workDetails: [
      "1. 누수 부위 정밀 진단 및 기존 실리콘 제거",
      "2. 창틀과 외벽 사이의 이물질 제거 및 청소",
      "3. 비오염성 고내후성 실리콘 도포",
      "4. 누수 취약 구간(모서리) 보강 처리",
      "5. 최종 검수 및 누수 차단 확인"
    ],
