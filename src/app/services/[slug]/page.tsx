      ...
      <main className="flex-grow bg-white">
        ...
        <section className="py-24 bg-gray-50 border-y border-gray-100">
          <div className="max-w-4xl mx-auto px-4">
            <h2 className="text-3xl font-black text-gray-900 mb-12 text-center">레인가드 프리미엄 시공 솔루션</h2>
        ...
        <section className="py-24 bg-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-500 mb-16 text-lg font-medium">레인가드는 수도권 전 지역에서 동일한 품질의 프리미엄 서비스를 제공합니다.</p>
        ...
        <section id="contact" className="py-24 bg-blue-600 text-white relative overflow-hidden" aria-labelledby="contact-title">
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 id="contact-title" className="text-3xl md:text-6xl font-black mb-8 leading-tight">레인가드 전문가가 <br /> 직접 안내해 드립니다</h2>
