...
export const metadata: Metadata = getMetadata({
  title: "시공 사례 (포트폴리오)",
  description: "지움 (Zium)의 실제 전문 시공 사례를 확인해 보세요. 아파트, 빌라, 상가까지 지역별 상황별로 완벽하게 해결한 곰팡이 박멸 사례를 상세히 공개합니다.",
  path: "/portfolio",
});
      ...
      <main className="flex-grow bg-white">
        ...
        <section className="bg-gray-50 py-24 relative overflow-hidden border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <span className="text-blue-600 font-bold tracking-widest uppercase mb-4 block">Zium Case Archive</span>
            <h1 className="text-4xl md:text-6xl font-black text-gray-900 mb-8 leading-tight">지움의 시공 기록</h1>
            <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed break-keep">
              가장 어려운 현장에서 검증된 지움의 기술력. <br />
        ...
        <section className="py-24 bg-blue-600 text-white">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <p className="text-blue-100 mb-12 text-lg font-medium opacity-90">지움(Zium)은 어떤 어려운 현장도 완벽히 해결할 준비가 되어 있습니다.</p>
            <Link 
              href="/#contact" 
